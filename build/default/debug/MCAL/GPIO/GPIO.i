...
# 193 "MCAL/GPIO/GPIO.c"
Std_ReturnType gpio_port_get_direction_status(PORT_index_t port , uint8* direction){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if( (((void*)0) == direction) || port > 5 -1){
        ret = (Std_ReturnType)0x00;
    }
    else{
